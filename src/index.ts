 ...
 */
function getComponentFiles(directory: string, includeDirs?: string[]): string[] {
 ...
 */
function extractImportedIgnoredComponents(content: string, ignoreLibs: string[]): Set<string> {
 ...
 */
function extractUsedComponents(content: string, ignoreLibs: string[]): Set<string> {
 ...
 */
function main(directory: string, ignoreLibs: string[], projectOnly: boolean, includeDirs: string[]) {
  ...
  const componentSet = new Set<string>(Array.from(fileToComponent.values()));
